...
public class ListarEspaconavesTest {
    ...
    public void testQuandoListoAsEspaconavesEntaoObtenhoStatusCode200EOsDadosDaResposta() {
        ...
        .then()
            .assertThat()
                ...
                .body("next", containsString("https://swapi.dev/api/starships/?page="))
                ...
                .body("results[0].hyperdrive_rating", isA(String.class))
                .body("results[0].MGLT", isA(String.class))
                .body("results[0].starship_class", isA(String.class))
                ...
                .body("results[0].url", containsString("https://swapi.dev/api/starships/"));
    }
}
